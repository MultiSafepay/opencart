 ...
 class ControllerExtensionPaymentMultiSafePaybanktrans extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset($this->request->post['payment_multisafepay_banktrans_geo_zone_id'])) {
            $data['payment_multisafepay_banktrans_geo_zone_id'] = $this->request->post['payment_multisafepay_banktrans_geo_zone_id'];
        } else {
            $data['payment_multisafepay_banktrans_geo_zone_id'] = $this->config->get('payment_multisafepay_banktrans_geo_zone_id');
        }

        if (isset($this->request->post['payment_multisafepay_banktrans_max_amount'])) {
            $data['payment_multisafepay_banktrans_max_amount'] = $this->request->post['payment_multisafepay_banktrans_max_amount'];
        } else {
            $data['payment_multisafepay_banktrans_max_amount'] = $this->config->get('payment_multisafepay_banktrans_max_amount');
        }
        if (isset($this->request->post['payment_multisafepay_banktrans_min_amount'])) {
            $data['payment_multisafepay_banktrans_min_amount'] = $this->request->post['payment_multisafepay_banktrans_min_amount'];
        } else {
            $data['payment_multisafepay_banktrans_min_amount'] = $this->config->get('payment_multisafepay_banktrans_min_amount');
        }
        ...
        if (isset($this->request->post['payment_multisafepay_banktrans_sort_order'])) {
            $data['payment_multisafepay_banktrans_sort_order'] = $this->request->post['payment_multisafepay_banktrans_sort_order'];
        } else {
            $data['payment_multisafepay_banktrans_sort_order'] = $this->config->get('payment_multisafepay_banktrans_sort_order');
        }
        ...
        foreach ($this->model_setting_store->getStores() as $store) {
            ...
            if (isset($this->request->post['payment_multisafepay_banktrans_max_amount_' . $store['store_id'] . ''])) {
                $data['payment_multisafepay_banktrans_max_amount_' . $store['store_id'] . ''] = $this->request->post['payment_multisafepay_banktrans_max_amount__' . $store['store_id'] . ''];
            } else {
            ...
            if (isset($this->request->post['payment_multisafepay_banktrans_status_' . $store['store_id'] . ''])) {
                $data['payment_multisafepay_banktrans_status_' . $store['store_id'] . ''] = $this->request->post['payment_multisafepay_banktrans_status_' . $store['store_id'] . ''];
            } else {
                $data['payment_multisafepay_banktrans_status_' . $store['store_id'] . ''] = $this->config->get('payment_multisafepay_banktrans_status_' . $store['store_id']);
            }

    ...
    public function index()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == "POST")){
            foreach($data['stores'] as $store) {
                $this->model_setting_setting->editSetting('payment_multisafepay_boekenbon', $this->request->post['stores'][$store['store_id']], $store['store_id']);
            }
        ...
        $fields = array (
            'payment_multisafepay_boekenbon_status',
            'payment_multisafepay_boekenbon_min_amount',
            'payment_multisafepay_boekenbon_max_amount',
            'payment_multisafepay_boekenbon_geo_zone_id',
            'payment_multisafepay_boekenbon_sort_order');

        foreach ($data['stores'] as $store) {
            $store_id = $store['store_id'];
            $config = $this->model_setting_setting->getSetting('payment_multisafepay_boekenbon', $store_id);

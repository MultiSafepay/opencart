...
class ModelExtensionPaymentMultiSafePayBabygiftcard extends Model
{
    ...
    public function getMethod($address, $total)
    {
        ...
        if (!$this->config->get('payment_multisafepay_babygiftcard_geo_zone_id' . $appendix)) {
            $status = true;
        ...
        if ($total) {
            if ($this->config->get('payment_multisafepay_babygiftcard_min_amount' . $appendix) && $totalcents < $this->config->get('payment_multisafepay_babygiftcard_min_amount' . $appendix)) {
                return false;
            }
            if ($this->config->get('payment_multisafepay_babygiftcard_max_amount' . $appendix) && $totalcents > $this->config->get('payment_multisafepay_babygiftcard_max_amount' . $appendix)) {
                return false;
            }
        }

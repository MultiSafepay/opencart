 ...
 */
class ControllerPaymentMultiSafePayWebshopgiftcard extends Controller {

    private $error = array();

    public function index() {
        $this->load->language('payment/multisafepay');
        $this->load->language('payment/multisafepay_webshopgiftcard');
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->setup_link('payment/multisafepay_webshopgiftcard'),
            'separator' => ' :: '
        );


        $this->template = 'payment/multisafepay_webshopgiftcard.tpl';

 ...
 */
class ControllerPaymentMultiSafePayBabygiftcard extends Controller {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->setup_link('payment/multisafepay_babygiftcard'),
            'separator' => ' :: '
        );


        $this->template = 'payment/multisafepay_babygiftcard.tpl';

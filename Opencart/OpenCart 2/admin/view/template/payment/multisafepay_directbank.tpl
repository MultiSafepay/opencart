            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-multisafepay" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="multisafepay_directbank_min_amount" value="<?php echo $multisafepay_directbank_min_amount; ?>" id="minamount" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="multisafepay_directbank_max_amount" value="<?php echo $multisafepay_directbank_max_amount; ?>" id="maxamount" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="multisafepay_directbank_geo_zone_id" id="input-geo-zone" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="multisafepay_directbank_sort_order" value="<?php echo $multisafepay_directbank_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
                        </div>
                    </div>
                </form>
            </div>

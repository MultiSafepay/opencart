...
class ControllerPaymentMultiSafepayKlarna extends Controller {
    ...
    public function index() {
        ...
        /*if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/multisafepay_klarna.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/payment/multisafepay_klarna.tpl', $data);
        } else {
            return $this->load->view('default/template/payment/multisafepay_klarna.tpl', $data);
        }*/
        return $this->load->view('payment/multisafepay_klarna.tpl', $data);
    }
    ...
    public function multisafepayProcess() {
        ...
        $msp->test = $this->config->get('multisafepay_klarna_environment');
        $msp->merchant['account_id'] = $this->config->get('multisafepay_klarna_merchant_id');
        $msp->merchant['site_id'] = $this->config->get('multisafepay_klarna_site_id');
        $msp->merchant['site_code'] = $this->config->get('multisafepay_klarna_secure_code');

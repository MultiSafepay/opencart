...
class Helper {
    ...
    public function __construct($registry) {
        ...
        $this->route = 'extension/payment/multisafepay';
    }
    ...
    public function getTaxClassFromFlatShippingMethod() {
        $query = $this->db->query("SELECT `value` FROM " . DB_PREFIX . "setting WHERE `key`='shipping_flat_tax_class_id'");
        if($query->row) {
    ...
    public function editTaxClassFromFlatShippingMethod($tax_class_id) {
        $this->db->query("UPDATE " . DB_PREFIX . "setting SET `value`='" . (int)$tax_class_id . "' WHERE `key`='shipping_flat_tax_class_id'");
    }

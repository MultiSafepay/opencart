...
$multisafepay= new Multisafepay($registry);
$registry->set('multisafepay', $multisafepay);

$multisafepay_version_control= new Multisafepayversioncontrol($registry);
$registry->set('multisafepay_version_control', $multisafepay_version_control);

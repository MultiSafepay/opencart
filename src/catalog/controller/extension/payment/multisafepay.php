...
class ControllerExtensionPaymentMultiSafePay extends Controller {
    ...
    private function paymentMethodBase() {
        ...
        $data['action'] = $this->url->link(self::ROUTE . '/confirm', '', true);
        $data['back'] = $this->url->link('checkout/checkout', '', true);
        $data['type'] = 'redirect';
        $data['test_mode'] = ($this->config->get('payment_multisafepay_environment')) ? true : false;
        return $data;
    }
    ...
    public function index() {
        ...
        return $this->load->view(self::ROUTE, $data);
    }
    ...
    public function callback() {
        ...
        switch ($status) {
            case 'completed':
                $order_status_id = $this->config->get('payment_multisafepay_order_status_id_completed');
                break;
            case 'uncleared':
                $order_status_id = $this->config->get('payment_multisafepay_order_status_id_uncleared');
                break;
            case 'reserved':
                $order_status_id = $this->config->get('payment_multisafepay_order_status_id_reserved');
                break;
            case 'void':
                $order_status_id = $this->config->get('payment_multisafepay_order_status_id_void');
                break;
            case 'cancelled':
                $order_status_id = $this->config->get('payment_multisafepay_order_status_id_cancelled');
                break;
            case 'declined':
                $order_status_id = $this->config->get('payment_multisafepay_order_status_id_declined');
                break;
            case 'reversed':
                $order_status_id = $this->config->get('payment_multisafepay_order_status_id_reversed');
                break;
            case 'refunded':
                $order_status_id = $this->config->get('payment_multisafepay_order_status_id_refunded');
                break;
            case 'partial_refunded':
                $order_status_id = $this->config->get('payment_multisafepay_order_status_id_partial_refunded');
                break;
            case 'expired':
                $order_status_id = $this->config->get('payment_multisafepay_order_status_id_expired');
                break;
            case 'shipped':
            ...
            case 'initialized':
                ...
                break;
            default:
                $order_status_id = $this->config->get('payment_multisafepay_order_status_id_initialized');
                break;
        }
        ...
        if($gateway_details['route'] != $order_info['payment_code']) {
             ...
             $this->model_extension_payment_multisafepay->editOrderPaymentMethod($order_id, $gateway_details);
        }
        ...
        if (!$order_status_id && $this->config->get('payment_multisafepay_debug_mode')) {

    ...
    <script type="text/javascript"><!--
        ...
        function getGooglePaymentsClient() {
            if (paymentsClient === null) {
                paymentsClient = new google.payments.api.PaymentsClient({
                    environment: '<?php echo $mode_string; ?>'
                });
            }
            ...
            paymentsClient.isReadyToPay(getGoogleIsReadyToPayRequest())
                .then(function(response) {
                    if (response.result) {
                        ...
                        $('#multisafepay-form').prepend('<div class="alert alert-danger alert-dismissible"><i class="fa fa-exclamation-circle"></i> <?php echo $text_error_google_pay; ?></div>');
                        $('#button-confirm').prop('disabled', true);
                    }
                })
                .catch(function(err) {
        ...
        $(document).ready(function() {
            if (window.PaymentRequest) {
                ...
                $('#multisafepay-form').prepend('<div class="alert alert-danger alert-dismissible"><i class="fa fa-exclamation-circle"></i> Please, use the secure context of your browser [HTTPS]. Thanks.</div>');
                $('#button-confirm').prop('disabled', true);
            }
        });
        //--></script>

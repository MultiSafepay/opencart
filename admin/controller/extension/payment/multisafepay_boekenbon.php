...
class ControllerExtensionPaymentMultiSafePayBoekenbon extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($this->model_setting_store->getStores() as $store) {
            ...
            if (isset($this->request->post['payment_multisafepay_boekenbon_geo_zone_id_' . $store['store_id'] . ''])) {
                $data['payment_multisafepay_boekenbon_geo_zone_id_' . $store['store_id'] . ''] = $this->request->post['payment_multisafepay_boekenbon_geo_zone_id_' . $store['store_id'] . ''];
            } else {
            ...
            if (isset($this->request->post['payment_multisafepay_boekenbon_min_amount_' . $store['store_id'] . ''])) {

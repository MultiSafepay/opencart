...
class ControllerExtensionPaymentMultiSafePayApplepay extends Controller
{
    ...
    public function index()
    {
        ...
        $this->load->language('extension/payment/multisafepay_applepay');
        ...
        if (($this->request->server['REQUEST_METHOD'] == "POST")){
            foreach($data['stores'] as $store) {
                $this->model_setting_setting->editSetting('payment_multisafepay_applepay', $this->request->post['stores'][$store['store_id']], $store['store_id']);
            }
        ...
        $data['action']                 = $this->setup_link('extension/payment/multisafepay_applepay');
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->setup_link('extension/payment/multisafepay_applepay'),
            'separator' => ' :: '
        );
        ...
        $fields = array (
            'payment_multisafepay_applepay_status',
            'payment_multisafepay_applepay_min_amount',
            'payment_multisafepay_applepay_max_amount',
            'payment_multisafepay_applepay_geo_zone_id',
            'payment_multisafepay_applepay_sort_order');

        foreach ($data['stores'] as $store) {
            $store_id = $store['store_id'];
            $config = $this->model_setting_setting->getSetting('payment_multisafepay_applepay', $store_id);
        ...
        $this->template = 'extension/payment/multisafepay_applepay';

    ...
    public function index()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == "POST")){
            foreach($data['stores'] as $store) {
                $this->model_setting_setting->editSetting('payment_multisafepay_babygiftcard', $this->request->post['stores'][$store['store_id']], $store['store_id']);
            }
        ...
        $fields = array (
            'payment_multisafepay_babygiftcard_status',
            'payment_multisafepay_babygiftcard_min_amount',
            'payment_multisafepay_babygiftcard_max_amount',
            'payment_multisafepay_babygiftcard_geo_zone_id',
            'payment_multisafepay_babygiftcard_sort_order');

        foreach ($data['stores'] as $store) {
            $store_id = $store['store_id'];
            $config = $this->model_setting_setting->getSetting('payment_multisafepay_babygiftcard', $store_id);

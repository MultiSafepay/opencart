 ...
 class ControllerExtensionPaymentMultiSafePaypayafter extends Controller
{
    ...
    public function index()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            $this->load->model('setting/setting');
            $this->model_setting_setting->editSetting('payment_multisafepay_payafter', $this->request->post);
        ...
        foreach ($this->model_setting_store->getStores() as $store) {
            ...
            if (isset($this->request->post['payment_multisafepay_payafter_min_amount_' . $store['store_id'] . ''])) {
                $data['payment_multisafepay_payafter_min_amount_' . $store['store_id'] . ''] = $this->request->post['payment_multisafepay_payafter_min_amount_' . $store['store_id'] . ''];
            } else {
            ...
            if (isset($this->request->post['payment_multisafepay_payafter_sort_order_' . $store['store_id'] . ''])) {
                ...
                $data['payment_multisafepay_payafter_sort_order_' . $store['store_id'] . ''] = $this->config->get('payment_multisafepay_payafter_sort_order_' . $store['store_id']);
            }
        }
        ...
        $this->template = 'extension/payment/multisafepay_payafter';

...
class ControllerExtensionPaymentMultiSafePayDirdeb extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset($this->request->post['payment_multisafepay_dirdeb_geo_zone_id_0'])) {
            $data['payment_multisafepay_dirdeb_geo_zone_id'] = $this->request->post['payment_multisafepay_dirdeb_geo_zone_id_0'];
        } else {
            $data['payment_multisafepay_dirdeb_geo_zone_id'] = $this->config->get('payment_multisafepay_dirdeb_geo_zone_id_0');
        }
        ...
        if (isset($this->request->post['payment_multisafepay_dirdeb_sort_order_0'])) {
            $data['payment_multisafepay_dirdeb_sort_order'] = $this->request->post['payment_multisafepay_dirdeb_sort_order_0'];
        } else {
            $data['payment_multisafepay_dirdeb_sort_order'] = $this->config->get('payment_multisafepay_dirdeb_sort_order_0');
        }
        if (isset($this->request->post['payment_multisafepay_dirdeb_max_amount_0'])) {
            $data['payment_multisafepay_dirdeb_max_amount'] = $this->request->post['payment_multisafepay_dirdeb_max_amount_0'];
        } else {
            $data['payment_multisafepay_dirdeb_max_amount'] = $this->config->get('payment_multisafepay_dirdeb_max_amount_0');
        }
        if (isset($this->request->post['payment_multisafepay_dirdeb_min_amount_0'])) {
            $data['payment_multisafepay_dirdeb_min_amount'] = $this->request->post['payment_multisafepay_dirdeb_min_amount_0'];
        } else {
            $data['payment_multisafepay_dirdeb_min_amount'] = $this->config->get('payment_multisafepay_dirdeb_min_amount_0');
        }
        ...
        foreach ($this->model_setting_store->getStores() as $store) {
            ...
            if (isset($this->request->post['payment_multisafepay_dirdeb_max_amount_' . $store['store_id'] . ''])) {
                $data['payment_multisafepay_dirdeb_max_amount_' . $store['store_id'] . ''] = $this->request->post['payment_multisafepay_dirdeb_max_amount_' . $store['store_id'] . ''];
            } else {
